...
func convertStepEventStateMetadata(md *engine.StepEventStateMetadata) *apitype.StepEventStateMetadata {
	...
	inputs, err := stack.SerializeProperties(md.Inputs, encrypter /* showSecrets */, false)
	contract.IgnoreError(err)

	outputs, err := stack.SerializeProperties(md.Outputs, encrypter /* showSecrets */, false)
	contract.IgnoreError(err)
